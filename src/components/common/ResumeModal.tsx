...
${EDUCATION.map(ed => `• ${ed.degree} — ${ed.institution}, ${ed.university} (${ed.duration})`).join('\n')}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1C1C1C]/60 backdrop-blur-xs overflow-y-auto animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl bg-[#FAFAF8] border border-[#1C1C1C]/30 shadow-2xl overflow-hidden my-8 text-[#1C1C1C] flex flex-col max-h-[90vh]">
        {/* Header bar */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#1C1C1C]/15 bg-[#FFF8DA]">
          <div className="flex items-center gap-3">
            <h3 className="font-sans font-bold text-lg text-[#1C1C1C]">Sanjay Dharan — Official Dossier & Resume</h3>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs font-sans uppercase tracking-wider font-semibold bg-white hover:bg-[#FAFAF8] text-[#1C1C1C] border border-[#1C1C1C]/20 flex items-center gap-1.5 transition-colors"
            ...
            <button
              onClick={handlePrint}
              className="px-3 py-1.5 text-xs font-sans uppercase tracking-wider font-bold bg-[#1C1C1C] hover:bg-[#333333] text-[#FAFAF8] flex items-center gap-1.5 transition-colors shadow-sm"
        ...
        <div className="p-6 sm:p-6 overflow-y-auto space-y-8 print:p-0 print:bg-white print:text-black">
          {/* Header section */}
          <div className="border-b border-[#1C1C1C]/15 pb-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-sans tracking-tight text-[#1C1C1C]">{PERSONAL_INFO.name}</h1>
                <p className="text-xs font-sans font-bold uppercase tracking-wider text-[#C7A600] mt-1">
              ...
              <div className="flex items-center gap-3 text-xs font-sans">
                <a
                  ...
                  className="px-3 py-2 bg-white hover:bg-[#FFF8DA] text-[#1C1C1C] flex items-center gap-1.5 transition-colors border border-[#1C1C1C]/20"
                >
                  <ExternalLink className="w-3.5 h-3.5 text-[#C7A600]" />
                  LinkedIn Profile
                </a>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-[#1C1C1C]/15 pb-2">
              <Briefcase className="w-4 h-4 text-[#C7A600]" />
              <h2 className="text-xl font-sans font-bold text-[#1C1C1C]">Professional Experience</h2>
            </div>
              ...
              {EXPERIENCES.map((exp) => (
                <div key={exp.id} className="relative pl-6 border-l-2 border-[#1C1C1C]/20 group hover:border-[#1C1C1C] transition-colors">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1">
                    <h3 className="font-sans font-bold text-lg text-[#1C1C1C]">{exp.role}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2 border-b border-[#1C1C1C]/15 pb-2">
                <GraduationCap className="w-4 h-4 text-[#C7A600]" />
                <h2 className="text-xl font-sans font-bold text-[#1C1C1C]">Education</h2>
              </div>
              ...
              {EDUCATION.map((edu, index) => (
                <div key={index} className="p-4 bg-white border border-[#1C1C1C]/15 shadow-sm">
                  ...
                  <p className="text-xs font-sans text-[#C7A600] font-medium mt-0.5">{edu.institution}</p>
                    ...
                    <ul className="mt-1 space-y-1 text-xs font-sans text-[#1C1C1C]/75">
                      {edu.coursework.slice(0, 4).map((c, i) => (
                        <li key={i} className="flex items-center gap-1.5">
                          <span className="text-[#C7A600]">•</span> {c}
                        </li>
                      ))}
                    </ul>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 border-b border-[#1C1C1C]/15 pb-2">
                <Award className="w-4 h-4 text-[#C7A600]" />
                <h2 className="text-xl font-sans font-bold text-[#1C1C1C]">Certifications</h2>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 border-b border-[#1C1C1C]/15 pb-2">
              <Code className="w-4 h-4 text-[#C7A600]" />
              <h2 className="text-xl font-sans font-bold text-[#1C1C1C]">Technical Competencies</h2>
            </div>
        ...
        {/* Footer CTA */}
        <div className="px-6 py-4 border-t border-[#1C1C1C]/15 bg-[#FFF8DA] flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="px-4 py-2 text-xs font-sans font-bold uppercase tracking-wider bg-[#1C1C1C] hover:bg-[#333333] text-[#FAFAF8] transition-colors shadow-sm"
            >

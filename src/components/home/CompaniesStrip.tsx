...
export const CompaniesStrip: React.FC<CompaniesStripProps> = ({ onNavigate }) => {
  return (
    <section className="py-14 bg-[#EBE7DE] border-b border-[#1C1C1C]/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-serif italic tracking-tight text-[#1C1C1C]">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#1C1C1C]/10">
                  ...
                  <span className="text-[10px] font-mono text-[#1C1C1C]/60 bg-[#F4F1EA] px-2 py-0.5 border border-[#1C1C1C]/10">
                    {exp.duration}
                  </span>
                </div>

                <h3 className="font-serif italic font-bold text-lg text-[#1C1C1C] group-hover:text-[#B85D19] transition-colors leading-snug">
                  {exp.role}
                </h3>
              ...
              <div className="mt-5 pt-3 border-t border-[#1C1C1C]/10 flex items-center justify-between text-xs font-sans">
                <span className="text-[#1C1C1C] font-semibold flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#B85D19]" />
